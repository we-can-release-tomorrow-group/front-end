		...
		<div class="title">登陆</div>
			<div class="form">
				...
				<div class="input-group input-group-sm">
					 ...
					 <input type="re_password" class="form-control" name="password" placeholder="请输入密码">
				</div>
			</div>
			<div class="anniu">
				<button type="button" class="btn btn-primary btn-sm btn-block" onclick="login()">提&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;交</button>
			</div>
	</body>
</html>
